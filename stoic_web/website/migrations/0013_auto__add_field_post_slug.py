...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_post', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug', max_length=50, unique=False),
                      keep_default=False)
        posts = orm['website.Post'].objects.all()
        for post in posts:
            post.slug = slugify(post.title)
            post.save()
        db.create_unique(u'website_post', ['slug'])


    def backwards(self, orm):
        # Deleting field 'Post.slug'
        db.delete_column(u'website_post', 'slug')
