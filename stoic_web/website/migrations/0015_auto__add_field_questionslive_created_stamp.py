...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionsLive.created_stamp'
        db.add_column(u'website_questionslive', 'created_stamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 2, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionsLive.created_stamp'
        db.delete_column(u'website_questionslive', 'created_stamp')
    ...
    models = {
        u'website.blog': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 12, 0, 0)'}),
        ...
        u'website.questionslive': {
            ...
            'created_stamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
