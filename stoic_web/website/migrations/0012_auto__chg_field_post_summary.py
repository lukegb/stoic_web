...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_post', 'summary', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Post.summary'
        db.alter_column(u'website_post', 'summary', self.gf('django.db.models.fields.CharField')(max_length=144))
